...
$footer_background_color = $settings->get('theme', 'footer_background_color', 'transparent');
$footer_border_radius = $settings->get('theme', 'footer_border_radius');
$footer_color = $settings->get('theme', 'footer_color', 'rgb(121 121 121 / 30%)');
...
$menu_main_background_image = $settings->get('theme', 'menu_main_background_image');
$menu_main_background_color = $settings->get('theme', 'menu_main_background_color', '#8800FF');
$menu_main_shadow_color = $settings->get('theme', 'menu_main_shadow_color', 'rgba(0, 0, 0, 0.24) 0px 3px 8px');
...
$menu_sub_shadow_color = $settings->get('theme', 'menu_sub_shadow_color', '0 0 5px '.$settings->get('theme', 'menu_sub_shadow_color', 'none'));
$menu_sub_border_radius = $settings->get('theme', 'menu_sub_border_radius');
...
$header_user_color_hover = $settings->get('theme', 'header_user_color_hover');
$header_domain_color_hover = $settings->get('theme', 'header_domain_color_hover');
...
$menu_side_state = $settings->get('theme', 'menu_side_state');
...
$button_border_color = $settings->get('theme', 'button_border_color', '#8800FF');
$button_border_radius = $settings->get('theme', 'button_border_radius');
$button_background_color = $settings->get('theme', 'button_background_color', '#333333');
$button_background_color_bottom = $settings->get('theme', 'button_background_color_bottom', '#333333');
...
$button_border_color_hover = $settings->get('theme', 'button_border_color_hover', '#a03cf7');
$button_background_color_hover = $settings->get('theme', 'button_background_color_hover', '#a03cf7');
$button_background_color_bottom_hover = $settings->get('theme', 'button_background_color_bottom_hover', '#a03cf7');
...
$domain_selector_shadow_color = $settings->get('theme', 'domain_selector_shadow_color', '0 0 10px '.$settings->get('theme', 'domain_selector_shadow_color', 'none'));
...
$domain_active_text_color_hover = $settings->get('theme', 'domain_active_text_color_hover', '#8800FF');
...
$login_body_background_color = $settings->get('theme', 'login_body_background_color', 'rgba(255,255,255,1)');
$login_body_border_radius = $settings->get('theme', 'login_body_border_radius');
...
$login_body_shadow_color = $settings->get('theme', 'login_body_shadow_color', '0 1px 20px #8800ffad');
...
$body_border_radius = $settings->get('theme', 'body_border_radius');
$body_shadow_color = $settings->get('theme', 'body_shadow_color', 'rgba(0, 0, 0, 0.35) 0px 5px 15px;');
...
$input_shadow_inner_color = $settings->get('theme', 'input_shadow_inner_color', '0 0 3px '.$settings->get('theme', 'input_shadow_inner_color', 'none').' inset');
$input_shadow_inner_color_focus = $settings->get('theme', 'input_shadow_inner_color_focus', '0 0 3px '.$settings->get('theme', 'input_shadow_inner_color_focus', 'none').' inset');
$input_shadow_outer_color = $settings->get('theme', 'input_shadow_outer_color', '0 0 5px '.$settings->get('theme', 'input_shadow_outer_color', 'none'));
$input_shadow_outer_color_focus = $settings->get('theme', 'input_shadow_outer_color_focus', '0 0 5px '.$settings->get('theme', 'input_shadow_outer_color_focus', 'none'));
$input_border_radius = $settings->get('theme', 'input_border_radius');
...
$table_row_background_color_hover = $settings->get('theme', 'table_row_background_color_hover');
...
$form_table_label_border_radius = $settings->get('theme', 'form_table_label_border_radius');
